 ...
 * @author Rafael
 */
public final class Servidor extends MIDlet implements CommandListener {
    
    private boolean midletPaused = false;
    private List lista;
    private Display display;
    private Command exit, commit, add;    
    private Group group;
    private ReceiveListener receiveListener;
    private static final String REPOSITORY_ADDRESS = "repSuperMercado";
    private static final String FILE_NAME = "promocoes.txt";
    ...
    public Servidor() {        
        ...
        commit = new Command("Commit", Command.OK, 0);
        group = new Group();
    }
    ...
    private void initializeButtons() {
        lista = new List("Gerenciador", List.IMPLICIT);
        lista.addCommand(exit);
        
        lista.setCommandListener(this);
        display.setCurrent(lista);
                
        lista.addCommand(add);
        lista.addCommand(commit);
    }
